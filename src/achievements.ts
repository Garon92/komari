...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'queen', title: 'Přemožitel královny', desc: 'Poraz královnu komárů.', icon: '👑' },
  { id: 'flawless', title: 'Bez štípance', desc: 'Dokonči vlnu (od 3. vlny), aniž by tě něco štíplo.', icon: '🛡️' },
  { id: 'sharp', title: 'Ostrostřelec', desc: 'Vlna (od 3. vlny) s přesností aspoň 90 % a aspoň 10 ranami.', icon: '🎖️' },
  ...
  { id: 'revenge', title: 'Srdíčko zpět', desc: 'Dostihni komára, který tě štípl.', icon: '❤️' },
